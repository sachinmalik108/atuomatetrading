...
tradingsymbollive = "Nifty Bank"
symboltokenlive = "99926009"
Quantity = '140'
exchlive = "NSE"
livesymbol = ''
livetoken = ''
...
# Get the first matching value
    ...
    while(True):
      ...
      if(formatted_now >= time305):
        ...
        scriptcesymbol = 'BANKNIFTY' + date + month + year+ livedata  + 'CE'
        scriptpesymbol = 'BANKNIFTY' + date + month + year + livedata  + 'PE'
