...
while(True):
    ...
    while(True):
      ...
      if(  
           formatted_now == time3pm1 or formatted_now == time3101  or formatted_now == time3051 or 
         formatted_now == time3151 or formatted_now == timempm1 or formatted_now == timep51 or
          formatted_now == time2011 or formatted_now == time2021  or formatted_now == time2031 or 
         formatted_now == time2041 or formatted_now == time2051  or formatted_now == time2061 or
          formatted_now == time2071 or formatted_now == time2081  or formatted_now == time2091 or 
         formatted_now == time2101 or formatted_now == time2111  or formatted_now == timep2121 or
          formatted_now == time1001 or formatted_now == time1101  or formatted_now == time1201 or
          formatted_now == time3pm or formatted_now == time310  or formatted_now == time305 or 
        ...
        # scriptcesymbol = 'NIFTY' + "17" + "JUL" + year+ livedata  + 'CE'
        # scriptpesymbol = 'NIFTY' + "17" + "JUL" + year + livedata  + 'PE'
        
        scriptcesymbol = 'SENSEX' + "257" + "22" +  livedata  + 'CE'
        scriptpesymbol = 'SENSEX' + "257"  + "22" +  livedata  + 'PE'
    ...
    while(True):
        ...
        if(float(ltp_value) >sellvalue):
            ...
            if(float(ltp_value) >highermore):
              newselltrigerprice =  math.ceil(0.96*(float(ltp_value)) * 10) / 10 
            ...
            if(newselltrigerprice>= trigerprice):
             ...
             # stoploss at 60% loss
        if(float(ltp_value) < 0.92*float(buyvalue) or float(ltp_value) > 1.1*float(buyvalue)):
            orderparams = {
                "variety": "NORMAL",
              "tradingsymbol": tradingsymbol,
                "symboltoken": symboltoken,
